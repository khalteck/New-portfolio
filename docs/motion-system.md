...
| Hero supporting-content stagger    | After hero heading begins                | 600 to 900 ms, `power2.out`                      | Intro, metrics, availability, and CTAs use transform/opacity; scoped cleanup                             | Stagger is tightened on compact layouts                                       | Final content renders immediately                                  |
